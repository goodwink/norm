...
/*
#cgo CFLAGS:  -I${SRCDIR}/norm/include -I${SRCDIR}/norm/protolib/include
#cgo LDFLAGS: -L${SRCDIR}/norm/lib -lnorm -L${SRCDIR}/norm/protolib/lib  -lprotokit -lpthread -lstdc++ -lm -lresolv
#include <stdlib.h>
#include "normApi.h"
*/
import "C"
